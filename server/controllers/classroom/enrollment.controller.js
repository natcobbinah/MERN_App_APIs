...
import Enrollment from '../../models/classroom/enrollment.model'
...
const readEnrollments = (req, res) => {
    return res.json(req.enrollment)
}

const completedEnrollments = async (req, res) => {
    let updatedData = {}
...
export default {
    findEnrollment, createEnrollment, enrollmentByID, isStudent, readEnrollments, completedEnrollments,
    listEnrolled, enrollmentStats
}